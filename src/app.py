...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team skills and compete in basketball games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "carlos@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and water safety instruction",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, perform plays, and build confidence",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["isabella@mergington.edu", "tyler@mergington.edu"]
    },
    "Debate Team": {
